...
import com.gailo22.domain.FlightIntegrationTest;
...
privileged aspect FlightIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    FlightDataOnDemand FlightIntegrationTest.dod;
    ...
    public void FlightIntegrationTest.testFindFlight() {
        ...
        Assert.assertEquals("Find method for 'Flight' returned the incorrect identifier", id, obj.getFlightId());
    }
    ...
    public void FlightIntegrationTest.testMergeUpdate() {
        ...
        obj.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getFlightId(), id);
    ...
    public void FlightIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Flight' identifier to be null", obj.getFlightId());
        try {
            obj.persist();
        ...
        obj.flush();
        Assert.assertNotNull("Expected 'Flight' identifier to no longer be null", obj.getFlightId());
    }
